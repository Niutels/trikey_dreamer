...
namespace gazebo
{
  class TrikeyPlugin: public ModelPlugin
  {
  public:
    TrikeyPlugin()
    {
      printf("Hello World!\n");
      std::cout << "Constructing TrikeyPlugin" << std::endl;
      first_iter=true;
    ...
    void Load(physics::ModelPtr _parent, sdf::ElementPtr sdfElement)
    {
      ...
      // std::cerr << "Loading TrikeyPlugin" << std::endl;
      this->model = _parent;
      this->updateConnection = event::Events::ConnectWorldUpdateBegin(boost::bind(&TrikeyPlugin::OnUpdate, this, _1));
...
// Register this plugin with the simulator
  GZ_REGISTER_MODEL_PLUGIN (TrikeyPlugin)
